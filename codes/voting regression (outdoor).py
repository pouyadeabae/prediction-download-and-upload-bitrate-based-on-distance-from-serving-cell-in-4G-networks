...
data = pd.read_csv (r'D:\project\outdoor.csv')
...
#DL
reg = neighbors.KNeighborsRegressor(n_neighbors =5,weights='distance')
...
#UL
reg2 = neighbors.KNeighborsRegressor(n_neighbors =100,weights='distance')
...
#######################RF
#DL
regr = RandomForestRegressor(max_depth=35,n_estimators=150,max_samples=0.98)
...
#Ul
regr2 = RandomForestRegressor(max_depth=70)
...
plt.ylabel('Speed (Kb)')
plt.xticks([3.14337358e-06,6.76723426e-04 , 1.57483016e-03 ,2.47293690e-03 , 3.37104364e-03 ,4.26915037e-03],['50','200','400','600','800','1000'])
plt.subplot(2,2,2)
...
plt.xticks([3.14337358e-06,6.76723426e-04 , 1.57483016e-03 ,2.47293690e-03 , 3.37104364e-03 ,4.26915037e-03],['50','200','400','600','800','1000'])
plt.subplot(2,2,3)
plt.plot(xtes,y_predvotplot,'g')
plt.title('Vot DL Pred')
plt.xlabel('Distance (m)')
plt.ylabel('Speed (Kb)')
plt.xticks([3.14337358e-06,6.76723426e-04 , 1.57483016e-03 ,2.47293690e-03 , 3.37104364e-03 ,4.26915037e-03],['50','200','400','600','800','1000'])
plt.subplot(2,2,4)
plt.plot(xtes,y_predvotULplot,'-r')
